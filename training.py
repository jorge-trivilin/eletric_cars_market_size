...
print("Cross-validation results without Electric Range:")
...
print("\nCross-validation results with all features:")
...
for fold_idx, (train_idx, test_idx) in enumerate(kfold.split(X_all_processed, y_encoded)):
    ...
    fold_model = xgb.XGBClassifier(random_state=42)
...
plt.title('Average Feature Importance Across CV Folds')
